...
function skillAcquisitionChart () {
  var cost = [6, 8, 12, 34, 36] //本期比上期（大于1按1处理）
  var totalCost = [100, 100, 100, 100, 100] //比例综合
  var visits = [   350,610,664, 702,793] //本期占总的百分比*100
  var grade = [ '广东', '江苏', '浙江', '四川','北京',]
...
function playCounts () {
  ...
  var option = {
    ...
    //   },
    //   extraCssText:
    //     'border-radius: 0;box-shadow: 0 0 3px rgba(0, 0, 0, 0.2);color: #333;',
    //   axisPointer: {
    //     type: 'shadow',
    //     shadowStyle: {
    //       color: '#ffffff',
