  ...
  <div style="background: #e8e8e8; height: 100%">
    <div class="subject_box">
      <left-menu :menus="menus" @now-title="getNowTitle" :index="index" ref="left">
        <ul slot="icon" id="homeIcon" class="sp_navbar" @click="doNavjump($event)">

          <li>
            <img src="../../assets/images/jsxmt_qmtjrznicon_20201125.png" alt="" /> 全媒体接入指南
          </li>
        </ul>
      </left-menu>
        ...
        .then(res => {
          if (type == 1) {
            ...
            for (var i = 0; i < res.data.data.rows.length; i++) {
                ...
                res.data.data.rows[i].isdelay = "分校资讯"
            ...
            for (var i = 0; i < res.data.data.rows.length; i++) {
                ...
                res.data.data.rows[i].isdelay = "通知公告"
